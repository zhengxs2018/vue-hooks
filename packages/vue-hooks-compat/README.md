...
基于 **vue2.x** 开发的 **hooks** 插件，未来将通过 `@vue/composition-api` 模块兼容 **vue2.x** 版本
...
```tsx
import { FunctionalComponent as FC, defineComponent } from '@vue/composition-api'
